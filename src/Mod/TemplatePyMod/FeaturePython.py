...
class Box(object):
    ...
    Example of use::
        ...
        myobj = doc.addObject("App::FeaturePython","MyName")
...
class ViewProviderBox(object):
    """Example Feature ViewProvider class."""
...
class Octahedron:
    ...
    def execute(self, obj):
        ...
        v3 = FreeCAD.Vector(0,obj.Width,0)
        v4 = FreeCAD.Vector(obj.Length,obj.Width,0)
        v5 = FreeCAD.Vector(obj.Length/2,obj.Width/2,obj.Height/2)
        v6 = FreeCAD.Vector(obj.Length/2,obj.Width/2,-obj.Height/2)
...
class ViewProviderOctahedron:
    ...
    def updateData(self, obj, prop):
        "If a property of the handled feature has changed we have the chance to handle this here"
        # obj is the handled feature, prop is the name of the property that has changed
        if prop == "Shape":
            s = obj.getPropertyByName("Shape")
...
class ViewProviderMolecule:
    ...
    def updateData(self, obj, prop):
        ...
        # obj is the handled feature, prop is the name of the property that has changed
        if prop == "p1":
            p = obj.getPropertyByName("p1")
            self.trl1.translation=(p.x,p.y,p.z)
        elif prop == "p2":
            p = obj.getPropertyByName("p2")
...
class ViewProviderCircleSet:
    ...
    def updateData(self, obj, prop):
            if prop == "Shape":
                edges=p = obj.getPropertyByName("Shape").Edges
                pts=[]
                ver=[]
                for i in edges:
                    length=i.Length
